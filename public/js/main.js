...
exports.default = {
	...
	computed: {
		alertsClasses: function alertsClasses() {
			var type = this.type;
			return {
				'alerts': true,
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div :class=\"alertsClasses\" v-show=\"show\">\n\t<slot></slot>\n\t<span class=\"alerts-close pull-right\" @click=\"show = false\">x</span>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/alexquang/Code/magicks/resources/assets/js/components/Alert.vue"
  if (!module.hot.data) {
...
new Vue({
	...
	data: {
		people: [{ name: 'Joe', role: 'admin' }, { name: 'Susan', role: 'admin' }, { name: 'Alex', role: 'student' }, { name: 'Jason', role: 'student' }]
	}
});
